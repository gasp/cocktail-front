...
function ImageShaker2({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="black"
      ...
      {...props}
    >
      <path d="M 0 0 H 458 V 458 H 0 L 0 0" />
      <path
        d="M364.396,40.34l-14.329-17.993V0H107.934v22.346L93.605,40.339c-3.427,4.303-6.229,12.323-6.229,17.823v335.51
